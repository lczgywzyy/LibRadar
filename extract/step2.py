...
lib_list = {
    ...
    "com/umeng/analytics": "Umeng Analytics - 友盟分析SDK",
    "com/umeng/update": "Umeng Update - 友盟自动更新SDK",
    "com/umeng/social_analytic": "Umeng Social Analytic - 友盟社会化分析SDK",
    "com/android/vending": "Google Play",
    "com/google/android/vending": "Google Play",
    "googlecode/apdfviewer": "Google Docs PDF Viewer - 谷歌PDF查看器",
    ...
    "pinyin4j": "Pinyin4j",
    "nostra13": "Nostra13 Image Loading - Nostra13图像加载",
    "appmakr": "Appmakr",
    ...
    "com/mobeta": "Mobeta",
    "sina/sso": "Sina SSO - 新浪微博开放平台SSO授权",
